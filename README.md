<h1>Privacy Preserving and Secure Machine Learning</h1>
...
Differential Privacy to protect individual data records

Secure Multi-Party Computation (SMPC) concepts

Federated Learning approach for decentralized training
